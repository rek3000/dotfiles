...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey }, "p", function() menubar.show() end,
		...
		-- Brightness control
		awful.key({ modkey }, "F11", function() awful.spawn("light -U 10") end,
							{description = "Decrease brightness"}),
		awful.key({ modkey }, "F12", function() awful.spawn("light -A 10") end,
		...
		awful.key({modkey  }, "F9", function() awful.spawn("saudio") end,
							{description = "Switch audio output"}),

		-- Screenshot
		awful.key({        }, "Print", function() awful.spawn("screen") end,
							{description = "Print Screen"}),
		awful.key({"Shift"}, "Print", function() awful.spawn("screensel") end,
							{description = "Print selected Screen"}),

		-- MIX
		awful.key({modkey, "Shift"}, "Delete", function() awful.spawn("power_option") end,
							{description = "Open POWER MENU"}),
		awful.key({modkey         }, "F1", function() awful.spawn("alacritty -e mpv av://v4l2:/dev/video0 --profile=low-latency --untimed") end,
							{description = "Open POWER MENU"})
